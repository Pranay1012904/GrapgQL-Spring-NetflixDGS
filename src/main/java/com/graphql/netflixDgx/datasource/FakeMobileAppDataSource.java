...
public class FakeMobileAppDataSource {
    ...
    @PostConstruct
    public void generateFakeMobileAppsList() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            var mobileApp = MobileApp.newBuilder().author(author).name(faker.app().name()).version(faker.app().version()).platform(getRandomPlatform()).build();
